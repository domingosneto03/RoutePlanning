//
// Created by domin on 23/02/2025.
//
...
public:
    ...
    T getInfo() const;
    std::string getLocation() const; // [!] MODIFIED
    std::string getCode() const; // [!] MODIFIED
    std::vector<Edge<T> *> getAdj() const;
    bool isVisited() const;
    bool isProcessing() const;
    int getParking() const; // [!] MODIFIED
    ...
    void setLocation(std::string location); // [!] MODIFIED
    void setCode(std::string code); // [!] MODIFIED
    void setParking(int parking); // [!] MODIFIED
...
protected:
    T info;                // info node
    std::string location; // [!] MODIFIED
    std::string code; // [!] MODIFIED
    std::vector<Edge<T> *> adj;  // outgoing edges

    // auxiliary fields
    bool visited = false; // used by DFS, BFS, Prim ...
    bool processing = false; // used by isDAG (in addition to the visited attribute)
    int parking; // [!] MODIFIED
...
protected:
    ...
    std::unordered_map<std::string, int> codeToId; // [!] MODIFIED
};
...
// [!] MODIFIED
template <class T>
int Graph<T>::getIdFromCode(const std::string& code) const {
...
// [!] MODIFIED
template <class T>
void Graph<T>::storeCode(const std::string& code, int id) {
    codeToId[code] = id;
}
